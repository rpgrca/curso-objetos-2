...
namespace PortfolioTreePrinter_Exercise_WithPortfolioImpl
{
    ...
    public class PortfolioTest
    {
        ...
        public void test20AccountSummaryShouldProvideHumanReadableTransactionsDetail()
        {
		    ...
		    Assert.AreEqual("Depósito por 100", lines.ElementAt(0));
            Assert.AreEqual("Extracción por 50", lines.ElementAt(1));
            Assert.AreEqual("Transferencia por -100", lines.ElementAt(2));
	    }
        ...
        public void test24AccountSummaryShouldWorkWithCertificateOfDeposit()
        {
            ...
            Assert.AreEqual("Extracción por 50", lines.ElementAt(1));
            Assert.AreEqual("Transferencia por -100", lines.ElementAt(2));
            Assert.AreEqual("Plazo fijo por 1000 durante 30 días a una tna de 0.1", lines.ElementAt(3));
	    }
        ...
        public void shouldTakeLessThan(Action should, double milliseconds)
        {
            ...
            Assert.IsTrue(timeAfterRunning.Subtract(timeBeforeRunning).TotalMilliseconds < milliseconds);
        }
	    ...
	    public void test28AccountSummaryWithInvestmentEarningsShouldNotTakeTooLong(){
		    ...
		    Assert.AreEqual("Extracción por 50", lines.ElementAt(1));
		    Assert.AreEqual("Transferencia por -100", lines.ElementAt(2));
		    Assert.AreEqual("Plazo fijo por 1000 durante 360 días a una tna de 0.1", lines.ElementAt(3));
		    Assert.AreEqual("Ganancias por 100", lines.ElementAt(4));
	    }
	    ...
	    public void test29AccountSummaryWithInvestmentFullInfoShouldNotTakeTooLong(){
            ...
            Assert.AreEqual("Plazo fijo por 1000 durante 360 días a una tna de 0.1", lines.ElementAt(3));
            Assert.AreEqual("Ganancias por 100", lines.ElementAt(4));
            Assert.AreEqual("Inversiones por 1000", lines.ElementAt(5));
	    }
